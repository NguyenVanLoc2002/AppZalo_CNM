...
const GroupDirectory = ({ navigation, route }) => {
  ...
  const { getAllGroup, getConversationById, getConversations, createGroup } =
    useCreateGroup();
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.section}>
          <View style={styles.groupHeader}>
            <Text style={styles.groupHeaderText}>
              Nhóm đang tham gia ({lengthGroup})
            </Text>
          ...
          {groupAll?.map((group, index) => (
            <Pressable
              ...
              onPress={() => navigation.navigate("Message", { group })}
            >
              <Image
                style={styles.avatar}
                source={{
                  uri: group.avatarGroup
                    ? group.avatarGroup
                    : "https://fptshop.com.vn/Uploads/Originals/2021/6/23/637600835869525914_thumb_750x500.png",
                }}
              />
              <View style={styles.groupTextContainer}>
                ...
                <Text style={styles.groupDescription}>
                  {group.userSendLast
                    ? `${group.userSendLast}: ${group.lastMessage}`
                    : "Chưa có tin nhắn"}
                </Text>
              </View>
      ...
      <Modal animationType="slide" transparent={true} visible={modalCreateGr}>
