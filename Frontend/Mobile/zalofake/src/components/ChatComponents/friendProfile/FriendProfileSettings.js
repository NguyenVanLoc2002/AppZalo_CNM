...
const toggleNotification = () => setNotification(!isNotification);

const [isBlockJournal, setBlockJournal] = useState(true);
const toggleBlockJournal = () => setBlockJournal(!isBlockJournal);

const [isHideJournal, setHideJournal] = useState(true);
const toggleHideJournal = () => setHideJournal(!isHideJournal);
    ...
    return (
        <View style={{ flex: 1, backgroundColor: '#E5E9EB' }}>
            <View style={{ backgroundColor: 'white' }}>
                ...
                <Pressable style={{ height: 50, paddingStart: 22, justifyContent: 'center' }}>
                    <Text style={{ fontSize: 16 }}>Đổi tên gợi nhớ</Text>
                </Pressable>
                <View style={{ height: 1, backgroundColor: 'gray', marginLeft: 20, marginEnd: 10, opacity: 0.2 }} />
                <Pressable style={{ height: 50, paddingStart: 22, justifyContent: 'center' }}>
                    <View style={{ flexDirection: 'row', alignItems: 'center' }}>
                        <Text style={{ fontSize: 16 }}>Đánh dấu bạn thân</Text>
                        <View style={{ flex: 1 }} />
                ...
                <Pressable style={{ height: 50, backgroundColor: 'white', paddingStart: 22, justifyContent: 'center' }}>
                    <Text style={{ fontSize: 16 }}>Giới thiệu cho bạn bè</Text>
                </Pressable>
            </View>
            <Pressable style={{ height: 80, backgroundColor: 'white', paddingStart: 22, justifyContent: 'center', marginTop: 10 }}>
                <Text style={{ fontWeight: '600', fontSize: 16, color: '#0091FF' }}>Thông báo</Text>
                <View style={{ flexDirection: 'row', alignItems: "center" }}>
                    <Text style={{ fontSize: 16 }}>Nhận thông báo về hoạt động của người này</Text>
                    <View style={{ flex: 1 }} />
            ...
            <View style={{ height: 130, backgroundColor: 'white', paddingStart: 22, marginTop: 10, justifyContent: 'center' }}>
                <Text style={{ fontWeight: '600', fontSize: 16, color: '#0091FF' }}>Cài đặt riêng tư</Text>
                <Pressable style={{ height: 50, justifyContent: 'center' }}>
                    <View style={{ flexDirection: 'row', alignItems: "center" }}>
                        <Text style={{ fontSize: 16 }}>Chặn xem nhật ký của tôi</Text>
                        <View style={{ flex: 1 }} />
                        <Switch
                            trackColor={{ false: '#767577', true: '#0091FF' }}
                ...
                <Pressable style={{ height: 50, justifyContent: 'center' }}>
                    <View style={{ flexDirection: 'row', alignItems:"center" }}>
                        <Text style={{ fontSize: 16 }}>Ẩn nhật ký của người này</Text>
                        <View style={{ flex: 1 }} />
                        <Switch
                            trackColor={{ false: '#767577', true: '#0091FF' }}
            ...
            <View style={{ flex: 1, backgroundColor: 'white', marginTop:10}}>
                <Pressable style={{ height: 50, paddingStart: 22, justifyContent: 'center' }}>
                    <Text style={{ fontSize: 16 }}>Báo xấu</Text>
                </Pressable>
                <View style={{ height: 1, backgroundColor: 'gray', marginLeft: 20, marginEnd: 10, opacity: 0.2 }} />
                <Pressable style={{ height: 50, paddingStart: 22, justifyContent: 'center' }}>
                    <Text style={{ fontSize: 16, color:'red' }}>Xóa bạn</Text>
                </Pressable>
                <View style={{ height: 1, backgroundColor: 'gray', marginLeft: 20, marginEnd: 10, opacity: 0.2 }} />
            </View>
        </View>
