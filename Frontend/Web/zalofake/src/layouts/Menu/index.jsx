...
function MenuComponent({ language, setLanguage, typeMenu, showModal }) {
  ...
  // Hàm render nội dung màn hình đổi mật khẩu
  const RenderChangePasswordScreen = () => {
    return (
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-4/5 h-[90%] bg-white rounded-lg shadow-lg ">
        ...
        <div className="p-4 ">
          <p className="text-sm">
            Lưu ý: Mật khẩu bao gồm chữ kèm theo số hoặc ký tự đặc biệt, tối
            thiểu 8 ký tự trở lên & tối đa 32 ký tự.
          </p>
          ...
          <p className="mt-2 border-t pt-2 pb-2">Nhập lại mật khẩu mới</p>
          <div className="flex justify-between p-2 border rounded border-sky-300 ">
            <input
    ...
    return (
      <div className="fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-3/5 h-[90%] bg-gray-100 rounded-lg shadow-lg ">
        ...
        <div
          ...
          onClick={(e) => e.stopPropagation()}
        >
          <div className="flex p-2 justify-end h-15" onClick={toggleModal}>
          ...
          {isOpenSecurity && (
            <div className="p-2">
              ...
              {showChangePassword && <RenderChangePasswordScreen />}
              ...
              <div className="mt-2 border-t">
                ...
                <p className="text-sm text-gray-300  mt-2">
                  Khóa màn hình Zalo của bạn bằng Ctrl + L, khi bạn không sử
                  dụng máy tính.
                </p>
              ...
              <div className="mt-2 border-t">
                ...
                <div className="flex justify-around">
                  <p className="text-sm text-gray-300  mt-2">
                    ...
                    từ thiết bị di động sau khi đăng nhập trên thiết bị lạ.
                  </p>
