...
function ModalComponent({ showModal, language, userInfo }) {
  ...
  const [usName, setUsName] = useState(userInfo.name);
  const [usGender, setUsGender] = useState(userInfo.gender);
  // const {dob} = userInfo;
                  ...
                  <div className="w-[30%]">
                    ...
                    >
                      {[...Array(31)].map((e, i) => (
                        <option
                          value={i + 1}
                          selected={i + 1 === userInfo.dob.getDate()}
                        >
                          {i + 1}
                        </option>
                      ))}
                  ...
                  <div className="w-[30%]">
                    ...
                    >
                      {[...Array(12)].map((e, i) => (
                        <option
                          value={i + 1}
                          selected={i === userInfo.dob.getMonth()}
                        >
                          {i + 1}
                        </option>
                      ))}
                  ...
                  <div className="w-[30%]">
                    ...
                    >
                      {[...Array(121)].map((e, i) => (
                        <option
                          value={i + 1920}
                          selected={i + 1920 === userInfo.dob.getFullYear()}
                        >
                          {i + 1920}
                        </option>
                      ))}
                ...
                <div className="-mt-6 ">
                  ...
                  <div className="mt-1 px-5 bg-white">
                    ...
                    <div className="flex items-center my-3">
                      ...
                      <h1 className="w-2/3">
                        {userInfo.dob.getDate() +
                          "/" +
                          (userInfo.dob.getMonth() + 1) +
                          "/" +
